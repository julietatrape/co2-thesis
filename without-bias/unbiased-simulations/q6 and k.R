...
LiqTrappe <- read.table("~/Escritorio/Tesis/Figuras/Metadinamica/TraPPE/Unbiased/Rigid-TraPPE/Liq-2GPa-350K-112mol", quote="\"")
ITrappe <- read.table("~/Escritorio/Tesis/Figuras/Metadinamica/TraPPE/Unbiased/Rigid-TraPPE/I-2GPa-350K-112mol", quote="\"")

# Data from CO2 simulations with potential OPLS
LiqOPLS <- read.table("~/Escritorio/Tesis/Figuras/Metadinamica/TraPPE/Unbiased/Flex-OPLS/Liq-2GPa-350K-108mol", quote="\"")
IOPLS <- read.table("~/Escritorio/Tesis/Figuras/Metadinamica/TraPPE/Unbiased/Flex-OPLS/I-2GPa-350K-108mol", quote="\"")

# Data from CO2 simulations with Neural Network potential 
LiqNN <- read.table("~/Escritorio/Tesis/Figuras/Metadinamica/TraPPE/Unbiased/NN/Liq-2GPa-350K-108mol", quote="\"")
INN <- read.table("~/Escritorio/Tesis/Figuras/Metadinamica/TraPPE/Unbiased/NN/I-2GPa-350K-108mol", quote="\"")
